...
- Cursor：changelog 条目（8/19）https://cursor.com/changelog/08-19-26 ；changelog 总页 https://cursor.com/changelog ；cloud agent 文档 https://cursor.com/docs/cloud-agent ；cloud subagents 背景（6/17）https://cursor.com/changelog/cloud-in-agents-window
