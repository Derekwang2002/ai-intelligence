...
- **TRIAL**：GitHub Copilot code review、MiniCPM5-2B、DeepSeek V4.1-Flash、Agents API、Cursor Projects、Muse 安全架构、RedKnot-MLA、在线 draft 共训练、harness 供应链审计、CapScope、SWE-Bench Pro Verified、真实性指令、MoEMB、Osprey、KVShareArena、Subagents vs Agent Skills、GPT-Image-2.5、IB2 协议。
- **WATCH**：Gemini CLI 0.61 nightly 安全加固、Mistral 主权开放权重投入、Anthropic 两份安全披露、FrogNano、Gander、**Navier–Stokes 千禧年解、forced Euler 争议**、copycat 动力学、Habitat 存储平台。
