...
const zh = {
  ...
  'radar.legendNote': '悬停显示名称，点击进详情 · 点击等级 / 象限标签聚焦',
  'radar.moreInArchive': '另有 {n} 条 · 事件库 →',
  ...
  'insights.radarTimeAria': '技术雷达：扇区为领域，环为建议等级（自内向外 ADOPT 至 IGNORE）',
  'insights.radarIntro': '每个光点是一条追踪条目：扇区是领域，环是处置建议——越靠圆心越值得行动。编号按象限编排，与右侧清单一一对应。',
  'insights.radarPulseNote': '脉冲环 = 近 2 天有活动',
  'insights.radarWindowNote': '近 {d} 天活跃条目 · 每象限各等级取评分最高前 6（IGNORE 前 4），其余在清单底部汇入事件库',
  'insights.matrix': '领域 × 日期',
  'insights.matrixMore': '再显示 {n} 天 · 还有 {m} 天',
  'insights.matrixArchive': '更早条目见事件库 →',
  'insights.archiveRetired': '已作废 / 退役趋势',
  'insights.archiveSnapshots': '趋势快照 · 按日归档',
  'insights.archiveSnapNote': '每次扫描后趋势看板的存档，高亮日期可点击查看当日快照。',
  ...
  'daily.calendar': '日报日历',
  'daily.calendarNote': '有报告的日期可点击直达；列表按月折叠，默认展开最新月份',
  'daily.reportUnit': '篇',
  'daily.collapseAll': '全部折叠',
  'daily.expandAll': '全部展开',
  'daily.secToggleAria': '点击折叠 / 展开本节',
  ...
  'events.calendar': '日历总览',
  'events.calendarNote': '色深 = 当日事件数；点击日期清除筛选并跳到对应分组',
  'events.calJumpAria': '{d} · {n} 个事件，点击跳转',
  'events.back': '← 事件',
  'events.summary': '摘要',
  'events.why': '为什么重要',
  'events.details': '技术细节',
...
const en: Record<UiKey, string> = {
  ...
  'radar.legendNote': 'Hover for names, click for details · click level / quadrant labels to focus',
  'radar.moreInArchive': '+{n} more · Events →',
  ...
  'insights.radarTimeAria': 'Tech radar: sectors = domains, rings = recommendation (ADOPT at the center, IGNORE outermost)',
  'insights.radarIntro': 'Each dot is a tracked entry: sector = domain, ring = recommendation — the closer to the center, the sooner you should act. Numbered per quadrant, matching the list on the right.',
  'insights.radarPulseNote': 'Pulsing ring = active within the last 2 days',
  'insights.radarWindowNote': 'Entries active in the last {d} days · top 6 per ring per quadrant (4 for IGNORE) by score; the rest roll into the archive links below each list',
  'insights.matrix': 'Domain × date',
  'insights.matrixMore': 'Show {n} earlier days · {m} to go',
  'insights.matrixArchive': 'Older entries in the Events archive →',
  'insights.archiveRetired': 'Invalidated / retired trends',
  'insights.archiveSnapshots': 'Trend snapshots by day',
  'insights.archiveSnapNote': "The trend board archived after each scan — highlighted days open that day's snapshot.",
  ...
  'daily.calendar': 'Report calendar',
  'daily.calendarNote': 'Days with reports are linked; the list folds by month with the latest month expanded',
  'daily.reportUnit': 'reports',
  'daily.collapseAll': 'Collapse all',
  'daily.expandAll': 'Expand all',
  'daily.secToggleAria': 'Click to collapse / expand this section',
  ...
  'events.countSuffix': '',
  'events.calendar': 'Calendar overview',
  'events.calendarNote': 'Darker = more events that day; click a day to clear filters and jump to its group',
  'events.calJumpAria': '{d} · {n} events, click to jump',
  'events.back': '← Events',
