...
const zh = {
  ...
  'radar.legendNote': '内环 → 外环，建议强度递减 · 悬停显示名称 · 点击象限/环聚焦',
  ...
  'insights.radarSnap': '象限快照',
  'insights.radarNote': '点大小 = 采用信号 · 脉冲 = 近 2 天新事件 · 三角 = 建议等级变动 · 悬停显示名称，点击进详情',
  'insights.radarTime': '时间分布',
  'insights.radarTimeAria': '事件时间分布：横向为发布日期，纵向为建议等级',
  'insights.radarTimeNote': '横向 = 发布日期 · 纵向 = 建议等级 · 颜色 = 象限：',
...
const en: Record<UiKey, string> = {
  ...
  'radar.legendNote':
    'Inner → outer rings: recommendation strength decreases · hover for names · click quadrant/ring to focus',
  ...
  'insights.radarSnap': 'Quadrant snapshot',
  'insights.radarNote':
    'Dot size = adoption signal · pulse = new in the last 2 days · triangle = recommendation change · hover for the name, click for details',
  'insights.radarTime': 'Over time',
  'insights.radarTimeAria': 'Event timeline: x = publication date, y = recommendation',
  'insights.radarTimeNote': 'x = publication date · y = recommendation · color = quadrant: ',
