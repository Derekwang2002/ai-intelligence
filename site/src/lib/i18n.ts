...
const zh = {
  ...
  'insights.radarIntro': '每个光点是一条追踪条目：扇区是领域，环是处置建议——越靠圆心越值得行动。光点编号与右侧清单一一对应。',
  'insights.radarPulseNote': '脉冲环 = 近 2 天新增',
...
const en: Record<UiKey, string> = {
  ...
  'insights.radarIntro': 'Each dot is a tracked entry: sector = domain, ring = recommendation — the closer to the center, the sooner you should act. Dot numbers match the list on the right.',
  'insights.radarPulseNote': 'Pulsing ring = new within the last 2 days',
