...
const zh = {
  ...
  'daily.moreReports': '再显示 {n} 篇 · 还有 {m} 篇',
  ...
  'events.moreDays': '再显示 {n} 天 · 还有 {m} 天',
  'events.back': '← 事件',
  'events.summary': '摘要',
  'events.why': '为什么重要',
  'events.details': '技术细节',
...
const en: Record<UiKey, string> = {
  ...
  'daily.moreReports': 'Show {n} older reports · {m} to go',
  ...
  'events.countSuffix': '',
  'events.moreDays': 'Show {n} earlier days · {m} to go',
  'events.back': '← Events',
