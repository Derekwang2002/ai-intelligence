...
- **Status:** emerging（2026-08-18 由 candidate 升级——跨组织原语已核实，包括早于本知识库覆盖的背景事实）
- **Confidence:** Medium
...
- **Why upgraded:** 等效原语已在五家组织（Anthropic、GitHub/Microsoft、DeepSeek、OpenAI、SST/OpenCode）得到核实，且从 2026 年 3 月持续至 8 月——时间持续性、多主体参与、技术收敛三项条件均满足。
...
- **Not yet established because:** 非 Anthropic 运行时尚无 inter-agent messaging 类原语（Codex/OpenCode 为 subagent 派生，非跨会话消息）；缺少公开的生产案例与采用遥测。
